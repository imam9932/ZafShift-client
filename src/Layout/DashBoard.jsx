...
const DashBoard = () => {
  ...
  <div className="drawer-content">
    ...
    <nav className="navbar w-full bg-base-300">
      ...
      <div className="px-4 "> 
        <h2 className='text-xl text-secondary text-center font-bold'>DashBoard</h2>
      </div>
    </nav>
    {/* Page content here */}
    <Outlet></Outlet>
    ...
    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      ...
      <ul className="menu w-full grow">
        ...
        <li>
          ...
          <Link to={'my-parcels'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Parcels">
